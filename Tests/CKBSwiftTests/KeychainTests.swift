...
class KeychainTests: XCTestCase {
    ...
    func testMasterFromLongSeed() throws {
        let master = try CKBKeyPair(seed: longSeed)
    ...
    func testChildHardened() throws {
        let master = try CKBKeyPair(seed: shortSeed)
        let child = try master.derivedKeychain(at: 0, hardened: true)
    ...
    func testChildNonHardened() throws {
        let master = try CKBKeyPair(seed: longSeed)
        let child = try master.derivedKeychain(at: 0, hardened: false)
    ...
    func testDerivePath() throws {
        let master = try CKBKeyPair(seed: shortSeed)
        XCTAssertEqual(
            try master.derivedKeychain(with: "m/0'")?.privateKey.toHexString(),
            "edb2e14f9ee77d26dd93b4ecede8d16ed408ce149b6cd80b0715a2d911a0afea"
        )
        let child = try master.derivedKeychain(with: "m/0'/1/2'")!
    ...
    func testDerivePathWithLargeIndex() throws {
        let master = try CKBKeyPair(seed: longSeed)
        XCTAssertEqual(
            try master.derivedKeychain(with: "m")?.privateKey.toHexString(),
            "4b03d6fc340455b363f51020ad3ecca4f0850280cf436c70c727923f6db46c3e"
        )
        var child = try master.derivedKeychain(with: "0/2147483647'")!
        ...
        child = try child.derivedKeychain(at: 1, hardened: false)
        ...
        child = try child.derivedKeychain(at: 2147483646, hardened: true)
    ...
    func testDeriveCkbSeed() throws{
        let master = try CKBKeyPair(seed: shortSeed)
        let extended = try master.derivedKeychain(with: "m/44'/309'/0'")
        ...
        let addressKey = try extended?.derivedKeychain(at: 0, hardened: false).derivedKeychain(at: 0, hardened: false)
    ...
    func testDeriveCkbSeed2() throws {
        ...
        let master = try CKBKeyPair(seed: seed)
        ...
        XCTAssertEqual(try master.derivedKeychain(with: "m/44'/309'/0'/0")?.privateKey.toHexString(), "047fae4f38b3204f93a6b39d6dbcfbf5901f2b09f6afec21cbef6033d01801f1")
        XCTAssertEqual(
            try master.derivedKeychain(with: "m/44'/309'/0'")?
        ...
        XCTAssertEqual(try master.derivedKeychain(with: "m/44'/309'/0'/0/0")?.privateKey.toHexString(), "848422863825f69e66dc7f48a3302459ec845395370c23578817456ad6b04b14")
        XCTAssertEqual(
            try master.derivedKeychain(with: "m/44'/309'/0'")?
                .derivedKeychain(at: 0, hardened: false)
                .derivedKeychain(at: 0, hardened: false)
    ...
    func testDeriveCkbFromMaster() throws {
        let master = try CKBKeyPair(
        ...
        XCTAssertEqual(
            try master.derivedKeychain(with: "m/44'/309'/0'")?.privateKey.toHexString(),
            "2925f5dfcbee3b6ad29100a37ed36cbe92d51069779cc96164182c779c5dc20e"
        )
        XCTAssertEqual(
            try master.derivedKeychain(with: "m/44'/309'/0'")!.derivedKeychain(at: 0, hardened: false).privateKey.toHexString(),
            "047fae4f38b3204f93a6b39d6dbcfbf5901f2b09f6afec21cbef6033d01801f1"
        )
        XCTAssertEqual(
            try master.derivedKeychain(with: "m/44'/309'/0'/0")!.privateKey.toHexString(),
            "047fae4f38b3204f93a6b39d6dbcfbf5901f2b09f6afec21cbef6033d01801f1"
        )
        XCTAssertEqual(
            try master.derivedKeychain(with: "m/44'/309'/0'")!.derivedKeychain(at: 0, hardened: false).derivedKeychain(at: 0, hardened: false).privateKey.toHexString(),
            "848422863825f69e66dc7f48a3302459ec845395370c23578817456ad6b04b14"
        )
        XCTAssertEqual(
            try master.derivedKeychain(with: "m/44'/309'/0'/0/0")?.privateKey.toHexString(),
            "848422863825f69e66dc7f48a3302459ec845395370c23578817456ad6b04b14"
        )
    }

    func testDeriveFromPublicKey()throws {
        let child = CKBKeyPair(
        ...
        let grandchild = try child.derivedKeychain(at: 2, hardened: false)
    ...
    func testDeriveFromXpubkey() throws{
        ...
        let extended = CKBKeyPair(publicKey: xpubkey[0..<33], chainCode: xpubkey[33..<65], path: "m/44'/309'/0'")
        let derived = try extended.derivedKeychain(with: "0/0")!
